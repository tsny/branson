...
The site was primarily designed for mobile and requires a google login.

This was my first time using next.js and my refresher for myself for `React` and `typescript`

![test](https://i.imgur.com/3b8Deee.png)
